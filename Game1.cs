...
namespace Sprint5
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
           ...
           MapGenerator.Instance.GenerateMap(4, "newMap"); //called when loading custom map mode. generates new xml


            GridGenerator.Instance.GetGrid(12, 7);
            RoomSpawner.Instance.LoadSprites(this);
            
            RoomSpawner.Instance.SwitchToCustomXML("newMap"); //change xml used to the one generated by GenerateMap
