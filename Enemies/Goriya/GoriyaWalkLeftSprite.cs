...
namespace Sprint3
{
    ...
    class GoriyaWalkLeftSprite : ISprite
    {
        ...
        private int row = EnemySpriteFactory.GetRow("RedGoriyaLeft");
        private int startColumn = EnemySpriteFactory.GetColumn("RedGoriyaLeft");
        ...
        public GoriyaWalkLeftSprite(Texture2D texture)
        {
