...
namespace Sprint5.ScreenHandling
{
    public class PauseScreen : IScreen
    {
        ...
        public MenuOption Background { get; set; } = new MenuOption(StateId.Controls, ScreenName.PauseBG);
        ...
        public PauseScreen()
        {
            ...
            Sprites.Add(new MenuOption(StateId.Pause, ScreenName.BackEsc));
            Sprites.Add(new MenuOption(StateId.Pause, ScreenName.BackB));
