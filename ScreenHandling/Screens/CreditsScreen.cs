...
namespace Sprint5.ScreenHandling
{
    public class CreditsScreen : IScreen
    {
       ...
       private MenuOption Background = new MenuOption(StateId.Controls, ScreenName.CreditsBG);
        ...
        {
            Options.Add(new MenuOption(StateId.Credits, ScreenName.BackSelect));
            Sprites.Add(new MenuOption(StateId.Credits, ScreenName.BackEsc));
            Sprites.Add(new MenuOption(StateId.Credits, ScreenName.BackB));
