...
namespace Sprint5.ScreenHandling
{
    public class OptionsScreen : IScreen
    {
        ...
        public MenuOption Background { get; set; } = new MenuOption(StateId.Controls, ScreenName.OptionsBG);
        ...
        public OptionsScreen()
        {
            ...
            Options.Add(new MenuOption(StateId.Options, ScreenName.OptionsKeyBindingsSelect));
