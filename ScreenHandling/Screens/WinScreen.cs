...
namespace Sprint5.ScreenHandling
{
    public class WinScreen : IScreen
    {
        ...
        public MenuOption Background { get; set; } = new MenuOption(StateId.Controls, ScreenName.WinBG);
        ...
        public WinScreen()
        {
            ...
            Options.Add(new MenuOption(StateId.Win, ScreenName.QuitSelect));

            Sprites.Add(new MenuOption(StateId.Stats, ScreenName.WinStatsSelect));
            Sprites.Add(new MenuOption(StateId.Credits, ScreenName.WinCreditsSelect));
            Sprites.Add(new MenuOption(StateId.Win, ScreenName.QuitSelect));

            Sprites.Add(new MenuOption(StateId.Win, ScreenName.BackEsc));
