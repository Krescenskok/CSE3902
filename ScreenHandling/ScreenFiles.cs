...
namespace Sprint5
{
    public class ScreenFiles
    {
        ...
        private ScreenFiles()
        {
            ...
            SpriteFileMap.Add(ScreenName.ModeBG, "ModeScreen");
            SpriteFileMap.Add(ScreenName.RogueLikeSelect, "ModeRogueSelect");
            SpriteFileMap.Add(ScreenName.ClassicSelect, "ModeClassicSelect");
            ...
            SpriteFileMap.Add(ScreenName.September, "september");
            ...
            SpriteFileMap.Add(ScreenName.SkinBG, "SelectSkinScreen");
            SpriteFileMap.Add(ScreenName.DifficultyBG, "DifficultyScreen");
            SpriteFileMap.Add(ScreenName.Navice, "DifficultyNaviceSelect");
            SpriteFileMap.Add(ScreenName.Tough, "DifficultyToughSelect");
            SpriteFileMap.Add(ScreenName.Nightmare, "DifficultyNightmareSelect");
            SpriteFileMap.Add(ScreenName.Normal, "DifficultyNormalSelect");
            SpriteFileMap.Add(ScreenName.Teal, "SelectSkinTeal");
            SpriteFileMap.Add(ScreenName.ClassicLink, "SelectScreenClassic");
            SpriteFileMap.Add(ScreenName.Yellow, "SelectScreenYellow");
            SpriteFileMap.Add(ScreenName.Red, "SelectSkinRed");
            SpriteFileMap.Add(ScreenName.Blue, "SelectSkinBlue");
            SpriteFileMap.Add(ScreenName.Pink, "SelectScreenPink");
        }
