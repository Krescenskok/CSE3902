...
namespace Sprint2
{
    ...
    /// Author: JT Thrash
    /// </summary>
    class GoriyaWalkDownSprite : ISprite
    {
        ...
        private int row = EnemySpriteFactory.GetRow("RedGoriyaDown");
        private int startColumn = EnemySpriteFactory.GetColumn("RedGoriyaDown");
        ...
        public GoriyaWalkDownSprite(Texture2D texture)
        {
