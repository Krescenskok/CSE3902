...
namespace Sprint2
{
    ...
    /// Author: JT Thrash
    /// </summary>
    class GoriyaWalkUpSprite : ISprite
    {
        ...
        private int row = EnemySpriteFactory.GetRow("RedGoriyaUp");
        private int startColumn = EnemySpriteFactory.GetColumn("RedGoriyaUp");
        ...
        public GoriyaWalkUpSprite(Texture2D texture)
        {
